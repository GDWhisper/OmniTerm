...
- **Single binary** — Rust backend with embedded frontend and SQLite. Install via shell script, Cargo (git), or Docker. One command to start.
...
| Distribution | shell script, Cargo (git), Docker |
