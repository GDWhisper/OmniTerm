...
`docs/dev/plans/2026-08-28-pty-frame-rle.md`。同探针、同环境（100×40），两种编码
...
| **P1** | 帧瘦身：RLE 行内编码 → **已实施**（2026-08-28，计划与实测见 `docs/dev/plans/2026-08-28-pty-frame-rle.md` §10） | 单帧 94.4 KB → **4.8 KB**（19.8×）、RTT p50 12.75 → 2.84 ms，四类内容无损 PASS | 无（与 P0 独立，可并行） |
