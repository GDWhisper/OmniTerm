...
> **2026-09-21 修复指向**：止血方案已按 `docs/dev/plans/archive/2026-09-21-acp-agent-connection-cpu-spin.md` 实施 Phase 1（P0）——omniterm 侧 killpg 杀 agent 进程组 + 共享构造核重构；精确触发条件（crate 内部 pidfd 等待路径的 poll/wake 交错）仍未钉死，Phase 2 fake agent 回归测试负责固化时序并向上游提 issue。
>
