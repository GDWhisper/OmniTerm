...
| `body.pixel-font-on` | always | `.font-logo` and `.font-pixel` use Press Start 2P |
...
| 元素 | 规格 |
|------|------|
| Tab 字体 | `.font-pixel` (Press Start 2P) 14px，letter-spacing 1.5px，**UPPERCASE** |
...
- **Tab 文字**：英文 UPPERCASE（Press Start 2P/VT323 不支持中文，pixel 风统一）
