...
- **单文件二进制** — Rust 后端内嵌前端与 SQLite。npm、cargo、shell 脚本或 Docker 安装。一条命令启动。
...
| 分发 | npm、shell 脚本、Docker、crates.io |

## 参与贡献

- ⭐ 加个 Star
- 🐛 [Issues](https://github.com/GDWhisper/OmniTerm/issues) — 提交 Bug 或想法
- 📖 架构文档：[`docs/architecture-backend.md`](docs/architecture-backend.md)、[`docs/architecture-frontend.md`](docs/architecture-frontend.md)
